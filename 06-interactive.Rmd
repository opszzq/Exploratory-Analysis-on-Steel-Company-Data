...
Compare between ROA(Return on Assets), ROE(Return On Equities) and ROS(Return on Sales) interactively.



<meta charset="utf-8">
<script src="https://d3js.org/d3.v5.js"></script>
<button onclick="update(ROA, 'ROA(%)')">ROA</button>
<button onclick="update(ROE, 'ROE(%)')">ROE</button>
<button onclick="update(ROS, 'ROS(%)')">ROS</button>
<div id="report"></div>
<style>
    .axisBlue text{
      fill: steelblue;
